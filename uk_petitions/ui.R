        ...
        sidebarPanel(
            ...
            HTML('
                ...
                <div style="font-size:11px;">
                    <ul>
                        <li> <a href="https://petition.parliament.uk/" target="_blank">Petitions. UK Government and Parliament</a> </li>
                        <li> Contains <a href="https://www.ons.gov.uk/peoplepopulationandcommunity/elections/electoralregistration" target="_blank"> National Statistics data </a> </li>
                        <li> Contains <a href="http://geoportal.statistics.gov.uk/" target="_blank">OS data</a> </li>
                    </ul>    
                    <p>All content is available under the Open Government Licence v3.0</p>
                    <p>&copy; Crown copyright and database right [2017]</p>
                </div>
            '),
